...
public class CSPResponseServiceLocator extends org.apache.axis.client.Service implements com.miri.blephone.mediainjector.iptv.c2.notify.CSPResponseService {
    ...
    public com.miri.blephone.mediainjector.iptv.c2.notify.CSPResponse getctms() throws javax.xml.rpc.ServiceException {
    ...
    public com.miri.blephone.mediainjector.iptv.c2.notify.CSPResponse getctms(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.miri.blephone.mediainjector.iptv.c2.notify.CtmsSoapBindingStub _stub = new com.miri.blephone.mediainjector.iptv.c2.notify.CtmsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.miri.blephone.mediainjector.iptv.c2.notify.CSPResponse.class.isAssignableFrom(serviceEndpointInterface)) {
                com.miri.blephone.mediainjector.iptv.c2.notify.CtmsSoapBindingStub _stub = new com.miri.blephone.mediainjector.iptv.c2.notify.CtmsSoapBindingStub(new java.net.URL(ctms_address), this);
                _stub.setPortName(getctmsWSDDServiceName());
                return _stub;
            }
        }
