...
@Service
public class CategoryAddAdiBuilderScheduler extends BuilderScheduler implements InitializingBean {
    ...
    public void build() {
        ...
        final List<Category> categories = this.dbRepository.querySeriesCategory(DBConstans.AssetStatus.INIT_ADD);
        ...
        for (final Category category : categories) {
            ...
            try {
                ...
                object.setID(id);
                object.setCode(id);
                object.setAction(ADIConstants.Action.REGIST);
                ...
                CategoryAddAdiBuilderScheduler.DLOG.error("Build adi xml fail.", e);
            }
            finally {
