...
public class DeleteClipAssetContent {
    ...
    protected DeleteClipContent content;
    ...
    /**
     * 获取content属性的值。
     * @return possible object is {@link DeleteClipContent }
     */
    public DeleteClipContent getContent() {
        return this.content;
    }

    /**
     * 设置content属性的值。
     * @param value allowed object is {@link DeleteClipContent }
     */
    public void setContent(final DeleteClipContent value) {
        this.content = value;
    }
