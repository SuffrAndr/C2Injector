...
public class UpdateFileAssetContent {
    ...
    @XmlElement(required = true, nillable = false)
    protected UpdateFileContent content;
    ...
    /**
     * 获取content属性的值。
     * @return possible object is {@link UpdateFileAssetContent.Content }
     */
    public UpdateFileContent getContent() {
        return this.content;
    }

    /**
     * 设置content属性的值。
     * @param value allowed object is {@link UpdateFileAssetContent.Content }
     */
    public void setContent(final UpdateFileContent value) {
        this.content = value;
    }
