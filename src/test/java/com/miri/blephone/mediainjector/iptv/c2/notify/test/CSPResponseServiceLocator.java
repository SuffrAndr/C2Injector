...
public class CSPResponseServiceLocator extends org.apache.axis.client.Service implements com.miri.blephone.mediainjector.iptv.c2.notify.test.CSPResponseService {
    ...
    public com.miri.blephone.mediainjector.iptv.c2.notify.test.CSPResponse getctms() throws javax.xml.rpc.ServiceException {
    ...
    public com.miri.blephone.mediainjector.iptv.c2.notify.test.CSPResponse getctms(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.miri.blephone.mediainjector.iptv.c2.notify.test.CtmsSoapBindingStub _stub = new com.miri.blephone.mediainjector.iptv.c2.notify.test.CtmsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.miri.blephone.mediainjector.iptv.c2.notify.test.CSPResponse.class.isAssignableFrom(serviceEndpointInterface)) {
                com.miri.blephone.mediainjector.iptv.c2.notify.test.CtmsSoapBindingStub _stub = new com.miri.blephone.mediainjector.iptv.c2.notify.test.CtmsSoapBindingStub(new java.net.URL(ctms_address), this);
                _stub.setPortName(getctmsWSDDServiceName());
                return _stub;
            }
        }
