...
@Service
public class MoviceDeleteAdiBuilderScheduler extends BuilderScheduler implements InitializingBean {
    ...
    public void build() {
        ...
        // TODO:检索电影
        final List<Category> categories = this.dbRepository.queryMovicesByStatus(DBConstans.AssetStatus.DELETE);
            ...
            if (CollectionUtils.isNotEmpty(clips) && clips.size() == 1) {
                ...
                if (CollectionUtils.isNotEmpty(files)) {
                    ...
                    try {
                        ...
                        pObj.setAction(ADIConstants.Action.DELETE);
                        ...
                        wsMsg.setOpType(DBConstans.WsOpType.DELETE);
                        ...
                        MoviceDeleteAdiBuilderScheduler.DLOG.error("Build adi xml fail.", e);
                    }
                    finally {
